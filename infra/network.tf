#
# Network - VPC 및 서브넷 설정
# 
# 퍼블릭 및 프라이빗 서브넷 이중화 (ap-northeast-2a, ap-northeast-2b)
# 퍼블릭 서브넷은 Internet Gateway, 프라이빗 서브넷은 NAT Gateway(A/B)를 통해 외부 통신
# 
...
# Public Subnet A (AZ: AP-Northeast-2a)
...
# Link Public Route Table to Public Subnet A
...
# Public Subnet B (AZ: AP-Northeast-2b)
...
# Link Public Route Table to Public Subnet B
...
# Private Subnet A (AZ: AP-Northeast-2a)
...
# Link Private Route Table to Private Subnet A
...
# Private Subnet B (AZ: AP-Northeast-2b)
...
# Link Private Route Table to Private Subnet B
